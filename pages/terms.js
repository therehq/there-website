        ...
        <SectionWrapper>
          <Container>
            <LandingPageArticle>
              ...
              <p>
                By downloading or using the app (referred to as There PM, There,
                or There™), these terms will automatically apply to you – you
                should make sure therefore that you read them carefully before
                using the app. You’re not allowed to copy, or modify the app,
                any part of the app, or our trademarks in any way. You’re not
                allowed to attempt to extract the source code of the app, and
                you also shouldn’t try to translate the app into other
                languages, or make derivative versions. The app itself, and all
                the trade marks, copyright, database rights and other
                intellectual property rights related to it, still belong to
                Mohammad Rajabifard.
              </p>

              <p>
                Mohammad Rajabifard is committed to ensuring that the app is as
              ...
              <p>
                The There PM app stores and processes personal data that you
                ...
                phone (in case for the mobile app), which is the process of
                removing software restrictions and limitations imposed by the
                official operating system of your device. It could make your
                phone vulnerable to malware/viruses/malicious programs,
                compromise your phone’s security features and it could mean that
                the There PM mobile app won’t work properly or at all.
              </p>

              <p>
                You should be aware that there are certain things that Mohammad
                Rajabifard will not take responsibility for. Certain functions
                of the app will require the app to have an active internet
                connection. The connection can be Wi-Fi, or provided by your
                mobile network provider, but Mohammad Rajabifard cannot take
              ...
              <p>
                Along the same lines, Mohammad Rajabifard cannot always take
                ...
                and you can’t turn it on to avail the Service, Mohammad
                Rajabifard cannot accept responsibility
              </p>

              <p>
                With respect to Mohammad Rajabifard’s responsibility for your
                ...
                you. Mohammad Rajabifard accepts no liability for any loss,
              ...
              <p>
                ...
                currently available on macOS and Windows (it might be available
                on mobile, if so, Android and/or iOS as well) – the requirements
                ...
                Mohammad Rajabifard does not promise that it will always update
                the app so that it is relevant to you and/or works with the
                macOS/Windows/iOS/Android version that you have installed on
